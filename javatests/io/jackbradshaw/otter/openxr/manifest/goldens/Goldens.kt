...
val goldenSecondaryManifests = buildMap<StandardInteractionProfile, String> {
  ...
  put(MICROSOFT_MIXED_REALITY_MOTION_CONTROLLER, readGoldenFile("microsoft_motion_controller.json"))
...
private fun readGoldenFile(filename: String) = File(
    Runfiles.create().rlocation("io_jackbradshaw/javatests/io/jackbradshaw/otter/openxr/manifest/goldens/$filename")
).readText()
