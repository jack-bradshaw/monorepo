...
class MenuNavigationTest {
  ...
  /**
   * Opens [startPagePath] in medium screen size, clicks [menuItem], and verifies the browser opened
   * [destinationPagePath].
   */
  ...
  /**
   * Opens [startPagePath] in small screen size, opens the primary navigation panel, clicks
  ...
  /**
   * Opens [startPagePath] in small screen size, opens the secondary navigation panel, clicks
   * [menuItem], and verifies the browser opened [destinationPagePath].
   */
