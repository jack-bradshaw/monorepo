...
class JournalContentAppearanceTest :
  ...
  @Test fun formats_smallScreen_collapsed() = runCollapsedTest("/journal/formats", ScreenWidth.SMALL)

  @Test fun formats_smallScreen_expanded() = runExpandedTest("/journal/formats", ScreenWidth.SMALL)

  @Test
  fun formats_mediumScreen_collapsed() = runCollapsedTest("/journal/formats", ScreenWidth.MEDIUM)

  @Test fun formats_mediumScreen_expanded() = runExpandedTest("/journal/formats", ScreenWidth.MEDIUM)

  @Test fun formats_largeScreen_collapsed() = runCollapsedTest("/journal/formats", ScreenWidth.LARGE)

  @Test fun formats_largeScreen_expanded() = runExpandedTest("/journal/formats", ScreenWidth.LARGE)
