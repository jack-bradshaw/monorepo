...
class SecondaryMenuAppearanceTest :
    BaseMenuAppearanceTest(MenuType.SECONDARY, SecondaryMenuAppearanceTest.GOLDEN_BASE_PATH) {
  ...
  companion object {
    ...
    private const val GOLDEN_BASE_PATH = "_main/first_party/site/tests/menu/secondary/goldens"
  }
}
