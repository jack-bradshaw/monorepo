...
class PrimaryMenuAppearanceTest :
  ...
  @Test fun journalFormats_smallScreen_collapsed() = runPopupCollapsedTest("/journal/formats")

  @Test fun journalFormats_smallScreen_expanded() = runPopupExpandedTest("/journal/formats")

  @Test
  fun journalFormats_mediumScreen() = runAlwaysExpandedTest("/journal/formats", ScreenWidth.MEDIUM)

  @Test
  fun journalFormats_largeScreen() = runAlwaysExpandedTest("/journal/formats", ScreenWidth.LARGE)
