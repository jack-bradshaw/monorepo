package com.jackbradshaw.otter.math.model
...
fun quaternion(
    scalar: Number = 1f,
    iCoefficient: Number = 0f,
    jCoefficient: Number = 0f,
    kCoefficient: Number = 0f
) =
...
operator fun Quaternion.plus(other: Quaternion): Quaternion =
    quaternion(
        scalar + other.scalar,
...
operator fun Quaternion.plus(scalar: Number): Quaternion =
    quaternion(this.scalar + scalar.toFloat(), iCoefficient, jCoefficient, kCoefficient)

operator fun Number.plus(quaternion: Quaternion): Quaternion = quaternion + this

operator fun Quaternion.minus(other: Quaternion): Quaternion =
    quaternion(
        scalar + other.scalar,
        iCoefficient = iCoefficient - other.iCoefficient,
        jCoefficient = jCoefficient - other.jCoefficient,
...
operator fun Quaternion.minus(scalar: Number): Quaternion =
    quaternion(this.scalar - scalar.toFloat(), iCoefficient, jCoefficient, kCoefficient)

operator fun Number.minus(quaternion: Quaternion): Quaternion = quaternion - this

/**
 * Calculates the [Hamilton product](https://en.wikipedia.org/wiki/Quaternion#Hamilton_product) of
 * this Quaternion with [other].
 */
operator fun Quaternion.times(other: Quaternion): Quaternion =
    quaternion(
        ...
        iCoefficient =
            this.scalar * other.iCoefficient +
                this.iCoefficient * other.scalar +
                this.jCoefficient * other.kCoefficient - this.kCoefficient * other.jCoefficient,
        jCoefficient =
            this.scalar * other.jCoefficient - this.iCoefficient * other.kCoefficient +
                this.jCoefficient * other.scalar +
                this.kCoefficient * other.iCoefficient,
        kCoefficient =
            this.scalar * other.kCoefficient + this.iCoefficient * other.jCoefficient -
                this.jCoefficient * other.iCoefficient + this.kCoefficient * other.scalar)

operator fun Quaternion.times(scalar: Number): Quaternion =
    quaternion(
...
operator fun Quaternion.div(scalar: Number): Quaternion =
    quaternion(
...
operator fun Quaternion.unaryMinus(): Quaternion =
    quaternion(-scalar, -iCoefficient, -jCoefficient, -kCoefficient)
...
val identityQuaternion =
    quaternion(scalar = 1, iCoefficient = 0, jCoefficient = 0, kCoefficient = 0)
