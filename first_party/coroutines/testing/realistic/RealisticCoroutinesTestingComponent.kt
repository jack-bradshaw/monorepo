 ...
 * meaning launched work does not block the test thread by default. Blocking the test thread while
 * background work completes is possible via the provided [taskBarrier], but virtual time
 * advancement is not supported in this environment due to the realistic nature of the execution
 * system.
 *
 * This component is ideal for testing systems that rely on a multi-threaded environment and would
 * experience thread starvation/deadlock if tested in a single-threaded test environment.
 */
