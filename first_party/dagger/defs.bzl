...
def kt_jvm_library_with_dagger(name, srcs = [], plugins = [], deps = [], **kwargs):
    ...
    kt_jvm_library(
        ...
        plugins = plugins + ["//first_party/dagger:dagger_ksp_plugin"],
        deps = deps + [
...
def kt_jvm_test_with_dagger(name, srcs = [], plugins = [], deps = [], **kwargs):
    ...
    Args:
        ...
        plugins: Additional KSP plugins, list of labels, optional, defaults to [].
        deps: Dependencies, list of labels, optional, defaults to [].
        **kwargs: Arbitrary arguments to forward to the underlying kt_jvm_test, dictionary, optional.
    """
...
def kt_jvm_binary_with_dagger(name, srcs = [], plugins = [], deps = [], **kwargs):
    """Wrapper for kt_jvm_binary that ensures Dagger KSP compilation triggers correctly.
    ...
    Args:
        ...
        plugins: Additional KSP plugins, list of labels, optional, defaults to [].
        deps: Dependencies, list of labels, optional, defaults to [].
        **kwargs: Arbitrary arguments to forward to the underlying kt_jvm_binary, dictionary, optional.
    """
