 ...
 * LibTestComponents.kt.
 */
class LibTest {

  private lateinit var component: LibTestComponent

  @Before
  fun setup() {
    val upstream =
        object : LibUpstreamComponent {
          override fun provideUpstreamString() = "Upstream"
        }

    component = DaggerLibTestComponent.builder().libUpstreamComponent(upstream).build()
  }
