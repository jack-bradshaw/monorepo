...
abstract class MetaComponentGeneratorTest {
  ...
  fun generateModuleForSimpleComponent() = runBlocking {
    val component =
        BackstabComponent(
            packageName = "com.example", name = "MyComponent", builder = Builder(emptyList()))
  ...
  fun generateModuleForComponentWithoutBuilder() = runBlocking {
    val component =
        BackstabComponent(packageName = "com.example", name = "NoBuilderComponent", builder = null)
        ...
        BackstabComponent(
            ...
            builder =
                Builder(
                    listOf(
                        BuilderMethod(
                            methodName = "bindFoo", paramType = ClassName("com.example", "Foo")))))
                        ...
                        BuilderMethod(
                            ...
                            paramType =
                                ClassName("com.example", "Foo")
                                    .copy(annotations = listOf(qualifierAnnotation))))))
