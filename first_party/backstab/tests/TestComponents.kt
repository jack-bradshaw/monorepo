...
@Component @TestScope @Backstab interface NoBuilderComponent
...
interface DeepMiddleComponent {
  ...
  @Component.Builder
  interface Builder {
    fun deepBottomComponent(b: DeepBottomComponent): Builder

    fun build(): DeepMiddleComponent
  }
}
...
interface DiamondSharedComponent {
  ...
  interface Builder {
    ...
    fun build(): DiamondSharedComponent
  }
}
...
interface DiamondLeftComponent {
  ...
  @Component.Builder
  interface Builder {
    fun diamondSharedComponent(s: DiamondSharedComponent): Builder

    fun build(): DiamondLeftComponent
  }
}
...
interface DiamondRightComponent {
  ...
  interface Builder {
    ...
    fun build(): DiamondRightComponent
  }
}
