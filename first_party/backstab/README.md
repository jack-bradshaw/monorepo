...
[design doc](/first_party/backstabmigrated/design.md).
...
kt_jvm_library_with_dagger(
    ...
    srcs = ["MyComponent.kt"],
    plugins = [
        "//first_party/backstabmigrated:plugin",
    ],
    deps = [
        "//first_party/backstabmigrated/annotations:backstab",
        "//first_party/backstabmigrated/annotations:aggregate_scope",
    ],
)
```
