package com.jackbradshaw.otter.openxr.manifest.goldens

import com.google.devtools.build.runfiles.Runfiles
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.GOOGLE_DAYDREAM_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.HTC_VIVE_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.HTC_VIVE_PRO
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.KHRONOS_SIMPLE_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.MICROSOFT_MIXED_REALITY_MOTION_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.MICROSOFT_XBOX_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.OCCULUS_GO_CONTROLLER
import com.jackbradshaw.otter.openxr.standard.StandardInteractionProfile.OCCULUS_TOUCH_CONTROLLER
...
private fun readGoldenFile(filename: String) =
    File(
            Runfiles.create()
                .rlocation(
                    "com_jackbradshaw/first_party/com/jackbradshaw/otter/openxr/manifest/testgoldens/$filename"))
        .readText()
