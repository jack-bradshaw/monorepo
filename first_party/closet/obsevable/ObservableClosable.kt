 ...
 *
 * Closure status is split into [hasTerminalState], which tracks whether the internal state of the
 * closable has reached a closed state, and [hasTerminatedProcesses] which tracks whether the
 ...
 *   true.
 *
 * Essentially, an observable closable broadcasts its closure state, differentiates between state
