...
abstract class ResourceManagerTest<K, V : ObservableClosable> {
  ...
  @Test
  fun validation_insertClosedResource_directOperation_getOrPut_isIgnoredAndUntracked() =
      runBlocking {
        val resourceManager = subject()
        val (key, value) = createKeyValuePair("test-key")
  ...
  @Test
  fun validation_insertClosedResource_exclusiveAccess_getOrPut_isIgnoredAndUntracked() =
      runBlocking {
        val resourceManager = subject()
        val (key, value) = createKeyValuePair("test-key")
  ...
  fun postManagerClosure_directOperation_get_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("get() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_size_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("size() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_isEmpty_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("isEmpty() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_containsKey_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("containsKey() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_containsValue_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("containsValue() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_put_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("put() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_getOrPut_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("getOrPut() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_remove_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("remove() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_directOperation_clear_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("clear() cannot be called while resourceManager is closed.")
  }
  ...
  fun postManagerClosure_exclusiveAccess_throwsIllegalStateException() = runBlocking {
    ...
    assertThat(e)
        .hasMessageThat()
        .isEqualTo("exclusiveAccess() cannot be called while resourceManager is closed.")
  }
