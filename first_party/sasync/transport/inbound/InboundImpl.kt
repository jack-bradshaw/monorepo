...
// TODO(jack-bradshaw): Measure performance. Could improve it by preallocating buffers on a separte
// thread in advance so there are always buffers ready for read operations. There are likely many
// other performance improvements that could be made too.
...
@AssistedFactory
interface InboundImplFactory {
  fun create(source: InputStream): InboundImpl
}
