...
1. Automation: A directive that is enforced by tooling. Automation directives represent requirements
   that are handled programmatically, but rationale is preserved for context.
