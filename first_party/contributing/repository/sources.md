...
Source files must use spaces for indentation instead of tabs; however, this directive does not apply
in any source file where tabs are required by the compiler; however, the conventions of other
codebases and communities are insufficient to override the requirement.
