...
intended use case (e.g. demo projects, proof of concept, temporary scripts), but the entire first
party property must be quarantined (visibility restricted to the containing 1p property). This
ensures unrefined AI generated code does not pollute the codebase and production.
[Example](/first_party/council/publicity.bzl).
