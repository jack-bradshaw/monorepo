...
- Abstraction & API Usability: Complex subsystems should expose simple, predictable interfaces that
  hide their internal complexity and configuration requirements. This allows maintainers and
...
preventing leaky abstractions, optimising build times, and directly separting production and test
...
### Practice: Component Suffix

Components should include the suffix `Component` in their name.
...
### Practice: Scope Naming Convention
...
required to instantiate components. Components that are exclusively consumed in the containing file
may exclude the factory function.
