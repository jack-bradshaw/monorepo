...
into Bazel. The [core bats utility](/third_party/bats-core) is contained in third party to separate
it from these the first party infrastructure in this package.
