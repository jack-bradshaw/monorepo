...
/** Abstract tests that all [SealedSession] instances should pass. */
@RunWith(JUnit4::class)
abstract class SealedSessionTest<T> {
  ...
  fun beforeClose_flowCollectedWhileAlreadyCollected_fails() =
      runBlocking<Unit> {
        ...
        val exception = assertFailsWith<IllegalStateException> { subject().flow.collect() }
  ...
  protected abstract fun subject(): SealedSession<T>
