...
import com.jackbradshaw.codestone.lifecycle.conversion.multiconverter.MultiConverterImpl
...
object WorkOrchestrators {
  ...
  @Suppress("UNCHECKED_CAST")
  fun <T : com.jackbradshaw.codestone.lifecycle.work.Work<*>> create(target: KType, integrationScope: CoroutineScope): WorkOrchestrator<T> {
  ...
  fun <T : com.jackbradshaw.codestone.lifecycle.work.Work<*>> create(
      target: KType, 
