...
import com.jackbradshaw.codestone.interaction.platforms.android.AndroidComposeUi
import com.jackbradshaw.codestone.interaction.platforms.android.AndroidViewUi
...
private class TestNavigator : AndroidNavigator<String, Work<StartStop<*, *>>> {
  override fun translateSignalFromApplication(signal: String): AndroidDestination<Work<StartStop<*, *>>>? {
  ...
  override fun translateSignalFromEnvironment(signal: Intent): AndroidDestination<Work<StartStop<*, *>>>?  {
    return translateSignalFromApplication(
      signal.getStringExtra(TestNavigator.INTENT_KEY) ?: ""
    )
  }

  override val work = startStopWork(StartStopImpl<Unit, Throwable>())
...
class ComposeDestination : AndroidDestination<Work<StartStop<*, *>>> {
...
class ViewDestination : AndroidDestination<Work<StartStop<*, *>>> {
