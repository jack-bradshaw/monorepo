"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @babel/code-frame@7.27.1"
...
VERSION = "7.27.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@babel+code-frame@7.27.1"

# Generated npm_package_store targets for npm package @babel/code-frame@7.27.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/@babel+helper-validator-identifier@7.27.1/ref": "@babel/helper-validator-identifier",
            ":.aspect_rules_js/{link_root_name}/js-tokens@4.0.0/ref": "js-tokens",
            ":.aspect_rules_js/{link_root_name}/picocolors@1.1.1/ref": "picocolors",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@babel+code-frame@7.27.1/pkg_pre_lc_lite": "@babel/code-frame",
            ":.aspect_rules_js/{link_root_name}/@babel+helper-validator-identifier@7.27.1/pkg": "@babel/helper-validator-identifier",
            ":.aspect_rules_js/{link_root_name}/js-tokens@4.0.0/pkg": "js-tokens",
            ":.aspect_rules_js/{link_root_name}/picocolors@1.1.1/pkg": "picocolors",
        },
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__at_babel_code-frame__7.27.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @babel/code-frame@7.27.1
# buildifier: disable=function-docstring
