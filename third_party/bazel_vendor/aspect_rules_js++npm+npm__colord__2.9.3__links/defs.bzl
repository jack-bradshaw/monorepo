"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package colord@2.9.3"
...
VERSION = "2.9.3"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "colord@2.9.3"

# Generated npm_package_store targets for npm package colord@2.9.3
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/colord@2.9.3/pkg_pre_lc_lite": "colord",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__colord__2.9.3//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package colord@2.9.3
# buildifier: disable=function-docstring
