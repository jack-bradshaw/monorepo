"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package keyv@4.5.4"
...
VERSION = "4.5.4"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "keyv@4.5.4"

# Generated npm_package_store targets for npm package keyv@4.5.4
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/json-buffer@3.0.1/ref": "json-buffer",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/json-buffer@3.0.1/pkg": "json-buffer",
            ":.aspect_rules_js/{link_root_name}/keyv@4.5.4/pkg_pre_lc_lite": "keyv",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__keyv__4.5.4//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package keyv@4.5.4
# buildifier: disable=function-docstring
