"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package big-integer@1.6.52"
...
VERSION = "1.6.52"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "big-integer@1.6.52"

# Generated npm_package_store targets for npm package big-integer@1.6.52
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/big-integer@1.6.52/pkg_pre_lc_lite": "big-integer",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__big-integer__1.6.52//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package big-integer@1.6.52
# buildifier: disable=function-docstring
