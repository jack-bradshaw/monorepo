"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package import-fresh@3.3.1"
...
VERSION = "3.3.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "import-fresh@3.3.1"

# Generated npm_package_store targets for npm package import-fresh@3.3.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/parent-module@1.0.1/ref": "parent-module",
            ":.aspect_rules_js/{link_root_name}/resolve-from@4.0.0/ref": "resolve-from",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/callsites@3.1.0/pkg": "callsites",
            ":.aspect_rules_js/{link_root_name}/import-fresh@3.3.1/pkg_pre_lc_lite": "import-fresh",
            ":.aspect_rules_js/{link_root_name}/parent-module@1.0.1/pkg": "parent-module",
            ":.aspect_rules_js/{link_root_name}/resolve-from@4.0.0/pkg": "resolve-from",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__import-fresh__3.3.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package import-fresh@3.3.1
# buildifier: disable=function-docstring
