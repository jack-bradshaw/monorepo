"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package error-ex@1.3.2"
...
VERSION = "1.3.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "error-ex@1.3.2"

# Generated npm_package_store targets for npm package error-ex@1.3.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/is-arrayish@0.2.1/ref": "is-arrayish",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/error-ex@1.3.2/pkg_pre_lc_lite": "error-ex",
            ":.aspect_rules_js/{link_root_name}/is-arrayish@0.2.1/pkg": "is-arrayish",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__error-ex__1.3.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package error-ex@1.3.2
# buildifier: disable=function-docstring
