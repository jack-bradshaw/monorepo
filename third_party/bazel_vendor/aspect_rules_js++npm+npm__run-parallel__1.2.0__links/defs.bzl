"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package run-parallel@1.2.0"
...
VERSION = "1.2.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "run-parallel@1.2.0"

# Generated npm_package_store targets for npm package run-parallel@1.2.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/queue-microtask@1.2.3/ref": "queue-microtask",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/queue-microtask@1.2.3/pkg": "queue-microtask",
            ":.aspect_rules_js/{link_root_name}/run-parallel@1.2.0/pkg_pre_lc_lite": "run-parallel",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__run-parallel__1.2.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package run-parallel@1.2.0
# buildifier: disable=function-docstring
