"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package espree@10.4.0"
...
VERSION = "10.4.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "espree@10.4.0"

# Generated npm_package_store targets for npm package espree@10.4.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/acorn@8.15.0/ref": "acorn",
            ":.aspect_rules_js/{link_root_name}/acorn-jsx@5.3.2_acorn_8.15.0/ref": "acorn-jsx",
        ...
        lc_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/acorn-jsx@5.3.2_acorn_8.15.0/pkg": "acorn-jsx",
            ":.aspect_rules_js/{link_root_name}/eslint-visitor-keys@4.2.1/pkg": "eslint-visitor-keys",
            ":.aspect_rules_js/{link_root_name}/espree@10.4.0/pkg_pre_lc_lite": "espree",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__espree__10.4.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package espree@10.4.0
# buildifier: disable=function-docstring
