"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package ansi-styles@4.3.0"
...
VERSION = "4.3.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "ansi-styles@4.3.0"

# Generated npm_package_store targets for npm package ansi-styles@4.3.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/color-convert@2.0.1/ref": "color-convert",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ansi-styles@4.3.0/pkg_pre_lc_lite": "ansi-styles",
            ":.aspect_rules_js/{link_root_name}/color-convert@2.0.1/pkg": "color-convert",
            ":.aspect_rules_js/{link_root_name}/color-name@1.1.4/pkg": "color-name",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__ansi-styles__4.3.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package ansi-styles@4.3.0
# buildifier: disable=function-docstring
