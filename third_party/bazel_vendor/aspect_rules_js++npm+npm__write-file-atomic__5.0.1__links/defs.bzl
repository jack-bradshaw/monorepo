"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package write-file-atomic@5.0.1"
...
VERSION = "5.0.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "write-file-atomic@5.0.1"

# Generated npm_package_store targets for npm package write-file-atomic@5.0.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/signal-exit@4.1.0/ref": "signal-exit",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/imurmurhash@0.1.4/pkg": "imurmurhash",
            ":.aspect_rules_js/{link_root_name}/signal-exit@4.1.0/pkg": "signal-exit",
            ":.aspect_rules_js/{link_root_name}/write-file-atomic@5.0.1/pkg_pre_lc_lite": "write-file-atomic",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__write-file-atomic__5.0.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package write-file-atomic@5.0.1
# buildifier: disable=function-docstring
