"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package css-functions-list@3.2.3"
...
PACKAGE = "css-functions-list"
VERSION = "3.2.3"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "css-functions-list@3.2.3"

# Generated npm_package_store targets for npm package css-functions-list@3.2.3
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/css-functions-list@3.2.3/pkg_pre_lc_lite": "css-functions-list",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__css-functions-list__3.2.3//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package css-functions-list@3.2.3
# buildifier: disable=function-docstring
