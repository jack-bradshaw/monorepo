"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package minimatch@9.0.5"
...
VERSION = "9.0.5"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "minimatch@9.0.5"

# Generated npm_package_store targets for npm package minimatch@9.0.5
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/brace-expansion@2.0.2/ref": "brace-expansion",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@2.0.2/pkg": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/minimatch@9.0.5/pkg_pre_lc_lite": "minimatch",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__minimatch__9.0.5//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package minimatch@9.0.5
# buildifier: disable=function-docstring
