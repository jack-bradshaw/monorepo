"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package reflect-metadata@0.1.13"
...
VERSION = "0.1.13"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "reflect-metadata@0.1.13"

# Generated npm_package_store targets for npm package reflect-metadata@0.1.13
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/reflect-metadata@0.1.13/pkg_pre_lc_lite": "reflect-metadata",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__reflect-metadata__0.1.13//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package reflect-metadata@0.1.13
# buildifier: disable=function-docstring
