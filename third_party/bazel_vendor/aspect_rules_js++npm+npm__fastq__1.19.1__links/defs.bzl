"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package fastq@1.19.1"
...
VERSION = "1.19.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "fastq@1.19.1"

# Generated npm_package_store targets for npm package fastq@1.19.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/reusify@1.1.0/ref": "reusify",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/fastq@1.19.1/pkg_pre_lc_lite": "fastq",
            ":.aspect_rules_js/{link_root_name}/reusify@1.1.0/pkg": "reusify",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__fastq__1.19.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package fastq@1.19.1
# buildifier: disable=function-docstring
