"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package file-entry-cache@8.0.0"
...
VERSION = "8.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "file-entry-cache@8.0.0"

# Generated npm_package_store targets for npm package file-entry-cache@8.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/flat-cache@4.0.1/ref": "flat-cache",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/file-entry-cache@8.0.0/pkg_pre_lc_lite": "file-entry-cache",
            ":.aspect_rules_js/{link_root_name}/flat-cache@4.0.1/pkg": "flat-cache",
            ":.aspect_rules_js/{link_root_name}/flatted@3.3.3/pkg": "flatted",
            ":.aspect_rules_js/{link_root_name}/json-buffer@3.0.1/pkg": "json-buffer",
            ":.aspect_rules_js/{link_root_name}/keyv@4.5.4/pkg": "keyv",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__file-entry-cache__8.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package file-entry-cache@8.0.0
# buildifier: disable=function-docstring
