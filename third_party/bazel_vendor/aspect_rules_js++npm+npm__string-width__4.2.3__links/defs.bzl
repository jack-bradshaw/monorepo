"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package string-width@4.2.3"
...
VERSION = "4.2.3"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "string-width@4.2.3"

# Generated npm_package_store targets for npm package string-width@4.2.3
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/emoji-regex@8.0.0/ref": "emoji-regex",
        ...
        lc_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/emoji-regex@8.0.0/pkg": "emoji-regex",
            ":.aspect_rules_js/{link_root_name}/is-fullwidth-code-point@3.0.0/pkg": "is-fullwidth-code-point",
            ":.aspect_rules_js/{link_root_name}/string-width@4.2.3/pkg_pre_lc_lite": "string-width",
            ":.aspect_rules_js/{link_root_name}/strip-ansi@6.0.1/pkg": "strip-ansi",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__string-width__4.2.3//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package string-width@4.2.3
# buildifier: disable=function-docstring
