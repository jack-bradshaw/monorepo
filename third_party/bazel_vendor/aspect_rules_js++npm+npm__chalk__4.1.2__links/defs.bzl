"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package chalk@4.1.2"
...
VERSION = "4.1.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "chalk@4.1.2"

# Generated npm_package_store targets for npm package chalk@4.1.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/ansi-styles@4.3.0/ref": "ansi-styles",
            ":.aspect_rules_js/{link_root_name}/supports-color@7.2.0/ref": "supports-color",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ansi-styles@4.3.0/pkg": "ansi-styles",
            ":.aspect_rules_js/{link_root_name}/chalk@4.1.2/pkg_pre_lc_lite": "chalk",
            ":.aspect_rules_js/{link_root_name}/color-convert@2.0.1/pkg": "color-convert",
            ":.aspect_rules_js/{link_root_name}/color-name@1.1.4/pkg": "color-name",
            ":.aspect_rules_js/{link_root_name}/has-flag@4.0.0/pkg": "has-flag",
            ":.aspect_rules_js/{link_root_name}/supports-color@7.2.0/pkg": "supports-color",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__chalk__4.1.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package chalk@4.1.2
# buildifier: disable=function-docstring
