"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package brace-expansion@2.0.2"
...
VERSION = "2.0.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "brace-expansion@2.0.2"

# Generated npm_package_store targets for npm package brace-expansion@2.0.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@2.0.2/pkg_pre_lc_lite": "brace-expansion",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__brace-expansion__2.0.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package brace-expansion@2.0.2
# buildifier: disable=function-docstring
