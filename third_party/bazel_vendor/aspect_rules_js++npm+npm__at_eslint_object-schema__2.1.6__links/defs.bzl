"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @eslint/object-schema@2.1.6"
...
PACKAGE = "@eslint/object-schema"
VERSION = "2.1.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@eslint+object-schema@2.1.6"

# Generated npm_package_store targets for npm package @eslint/object-schema@2.1.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+object-schema@2.1.6/pkg_pre_lc_lite": "@eslint/object-schema",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_eslint_object-schema__2.1.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @eslint/object-schema@2.1.6
# buildifier: disable=function-docstring
