"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package supports-color@7.2.0"
...
VERSION = "7.2.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "supports-color@7.2.0"

# Generated npm_package_store targets for npm package supports-color@7.2.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/has-flag@4.0.0/pkg": "has-flag",
            ":.aspect_rules_js/{link_root_name}/supports-color@7.2.0/pkg_pre_lc_lite": "supports-color",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__supports-color__7.2.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package supports-color@7.2.0
# buildifier: disable=function-docstring
