"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package json-schema-traverse@1.0.0"
...
VERSION = "1.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "json-schema-traverse@1.0.0"

# Generated npm_package_store targets for npm package json-schema-traverse@1.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/json-schema-traverse@1.0.0/pkg_pre_lc_lite": "json-schema-traverse",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__json-schema-traverse__1.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package json-schema-traverse@1.0.0
# buildifier: disable=function-docstring
