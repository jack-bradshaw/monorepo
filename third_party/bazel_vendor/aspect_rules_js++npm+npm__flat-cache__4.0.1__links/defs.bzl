"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package flat-cache@4.0.1"
...
VERSION = "4.0.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "flat-cache@4.0.1"

# Generated npm_package_store targets for npm package flat-cache@4.0.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/flat-cache@4.0.1/pkg_pre_lc_lite": "flat-cache",
            ":.aspect_rules_js/{link_root_name}/flatted@3.3.3/pkg": "flatted",
            ":.aspect_rules_js/{link_root_name}/json-buffer@3.0.1/pkg": "json-buffer",
            ":.aspect_rules_js/{link_root_name}/keyv@4.5.4/pkg": "keyv",
        },
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__flat-cache__4.0.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package flat-cache@4.0.1
# buildifier: disable=function-docstring
