"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package debug@4.4.1"
...
VERSION = "4.4.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "debug@4.4.1"

# Generated npm_package_store targets for npm package debug@4.4.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/ms@2.1.3/ref": "ms",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/debug@4.4.1/pkg_pre_lc_lite": "debug",
            ":.aspect_rules_js/{link_root_name}/ms@2.1.3/pkg": "ms",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__debug__4.4.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package debug@4.4.1
# buildifier: disable=function-docstring
