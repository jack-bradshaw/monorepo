"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @eslint/config-array@0.19.2"
...
PACKAGE = "@eslint/config-array"
VERSION = "0.19.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@eslint+config-array@0.19.2"

# Generated npm_package_store targets for npm package @eslint/config-array@0.19.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+object-schema@2.1.6/ref": "@eslint/object-schema",
            ":.aspect_rules_js/{link_root_name}/debug@4.4.1/ref": "debug",
            ":.aspect_rules_js/{link_root_name}/minimatch@3.1.2/ref": "minimatch",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+config-array@0.19.2/pkg_pre_lc_lite": "@eslint/config-array",
            ":.aspect_rules_js/{link_root_name}/@eslint+object-schema@2.1.6/pkg": "@eslint/object-schema",
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/pkg": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/pkg": "concat-map",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__at_eslint_config-array__0.19.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @eslint/config-array@0.19.2
# buildifier: disable=function-docstring
