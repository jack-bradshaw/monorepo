"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @xml-tools/parser@1.0.11"
...
PACKAGE = "@xml-tools/parser"
VERSION = "1.0.11"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@xml-tools+parser@1.0.11"

# Generated npm_package_store targets for npm package @xml-tools/parser@1.0.11
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/chevrotain@7.1.1/ref": "chevrotain",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@xml-tools+parser@1.0.11/pkg_pre_lc_lite": "@xml-tools/parser",
            ":.aspect_rules_js/{link_root_name}/chevrotain@7.1.1/pkg": "chevrotain",
            ":.aspect_rules_js/{link_root_name}/regexp-to-ast@0.5.0/pkg": "regexp-to-ast",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__at_xml-tools_parser__1.0.11//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @xml-tools/parser@1.0.11
# buildifier: disable=function-docstring
