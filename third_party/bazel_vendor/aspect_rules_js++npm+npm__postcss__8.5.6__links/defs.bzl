"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package postcss@8.5.6"
...
VERSION = "8.5.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "postcss@8.5.6"

# Generated npm_package_store targets for npm package postcss@8.5.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/nanoid@3.3.11/ref": "nanoid",
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/nanoid@3.3.11/pkg": "nanoid",
            ":.aspect_rules_js/{link_root_name}/picocolors@1.1.1/pkg": "picocolors",
            ":.aspect_rules_js/{link_root_name}/postcss@8.5.6/pkg_pre_lc_lite": "postcss",
            ":.aspect_rules_js/{link_root_name}/source-map-js@1.2.1/pkg": "source-map-js",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__postcss__8.5.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package postcss@8.5.6
# buildifier: disable=function-docstring
