...
class ReusableTest {
  @Test
  fun testReusable() {
    val parent = DaggerComponentWithReusableBindings.create()
    val childOne = parent.childOne()
    val childTwo = parent.childTwo()
    val reusableInParent = parent.reusableInParent()
    ...
    val reusableFromChildOne = childOne.reusableInChild()
    assertThat(childOne.reusableInChild()).isSameInstanceAs(reusableFromChildOne)

    val reusableFromChildTwo = childTwo.reusableInChild()
