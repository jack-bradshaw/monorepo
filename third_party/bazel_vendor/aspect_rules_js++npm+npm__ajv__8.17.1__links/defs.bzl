"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package ajv@8.17.1"
...
VERSION = "8.17.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "ajv@8.17.1"

# Generated npm_package_store targets for npm package ajv@8.17.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/fast-uri@3.1.0/ref": "fast-uri",
            ":.aspect_rules_js/{link_root_name}/json-schema-traverse@1.0.0/ref": "json-schema-traverse",
            ":.aspect_rules_js/{link_root_name}/require-from-string@2.0.2/ref": "require-from-string",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ajv@8.17.1/pkg_pre_lc_lite": "ajv",
            ":.aspect_rules_js/{link_root_name}/fast-deep-equal@3.1.3/pkg": "fast-deep-equal",
            ":.aspect_rules_js/{link_root_name}/fast-uri@3.1.0/pkg": "fast-uri",
            ":.aspect_rules_js/{link_root_name}/json-schema-traverse@1.0.0/pkg": "json-schema-traverse",
            ":.aspect_rules_js/{link_root_name}/require-from-string@2.0.2/pkg": "require-from-string",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__ajv__8.17.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package ajv@8.17.1
# buildifier: disable=function-docstring
