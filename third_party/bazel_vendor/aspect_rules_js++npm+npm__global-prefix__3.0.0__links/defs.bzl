"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package global-prefix@3.0.0"
...
VERSION = "3.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "global-prefix@3.0.0"

# Generated npm_package_store targets for npm package global-prefix@3.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/ini@1.3.8/ref": "ini",
            ":.aspect_rules_js/{link_root_name}/kind-of@6.0.3/ref": "kind-of",
            ":.aspect_rules_js/{link_root_name}/which@1.3.1/ref": "which",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/global-prefix@3.0.0/pkg_pre_lc_lite": "global-prefix",
            ":.aspect_rules_js/{link_root_name}/ini@1.3.8/pkg": "ini",
            ":.aspect_rules_js/{link_root_name}/isexe@2.0.0/pkg": "isexe",
            ":.aspect_rules_js/{link_root_name}/kind-of@6.0.3/pkg": "kind-of",
            ":.aspect_rules_js/{link_root_name}/which@1.3.1/pkg": "which",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__global-prefix__3.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package global-prefix@3.0.0
# buildifier: disable=function-docstring
