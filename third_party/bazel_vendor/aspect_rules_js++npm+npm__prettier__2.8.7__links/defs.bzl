...
# Generated npm_package_store targets for npm package prettier@2.8.7
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/prettier@2.8.7/pkg_pre_lc_lite": "prettier",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__prettier__2.8.7//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package prettier@2.8.7
# buildifier: disable=function-docstring
