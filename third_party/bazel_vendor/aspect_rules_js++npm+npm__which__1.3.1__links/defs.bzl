"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package which@1.3.1"
...
VERSION = "1.3.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "which@1.3.1"

# Generated npm_package_store targets for npm package which@1.3.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/isexe@2.0.0/ref": "isexe",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/isexe@2.0.0/pkg": "isexe",
            ":.aspect_rules_js/{link_root_name}/which@1.3.1/pkg_pre_lc_lite": "which",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__which__1.3.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package which@1.3.1
# buildifier: disable=function-docstring
