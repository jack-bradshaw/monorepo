"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package postcss-resolve-nested-selector@0.1.6"
...
VERSION = "0.1.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "postcss-resolve-nested-selector@0.1.6"

# Generated npm_package_store targets for npm package postcss-resolve-nested-selector@0.1.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/postcss-resolve-nested-selector@0.1.6/pkg_pre_lc_lite": "postcss-resolve-nested-selector",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__postcss-resolve-nested-selector__0.1.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package postcss-resolve-nested-selector@0.1.6
# buildifier: disable=function-docstring
