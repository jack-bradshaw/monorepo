"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @types/uuid@8.3.4"
...
VERSION = "8.3.4"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@types+uuid@8.3.4"

# Generated npm_package_store targets for npm package @types/uuid@8.3.4
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@types+uuid@8.3.4/pkg_pre_lc_lite": "@types/uuid",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_types_uuid__8.3.4//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @types/uuid@8.3.4
# buildifier: disable=function-docstring
