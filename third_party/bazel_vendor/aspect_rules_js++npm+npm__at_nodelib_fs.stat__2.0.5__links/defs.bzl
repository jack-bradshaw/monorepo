"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @nodelib/fs.stat@2.0.5"
...
VERSION = "2.0.5"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@nodelib+fs.stat@2.0.5"

# Generated npm_package_store targets for npm package @nodelib/fs.stat@2.0.5
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@nodelib+fs.stat@2.0.5/pkg_pre_lc_lite": "@nodelib/fs.stat",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_nodelib_fs.stat__2.0.5//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @nodelib/fs.stat@2.0.5
# buildifier: disable=function-docstring
