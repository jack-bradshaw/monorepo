"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package parse-json@5.2.0"
...
VERSION = "5.2.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "parse-json@5.2.0"

# Generated npm_package_store targets for npm package parse-json@5.2.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/@babel+code-frame@7.27.1/ref": "@babel/code-frame",
            ":.aspect_rules_js/{link_root_name}/error-ex@1.3.2/ref": "error-ex",
            ":.aspect_rules_js/{link_root_name}/json-parse-even-better-errors@2.3.1/ref": "json-parse-even-better-errors",
            ":.aspect_rules_js/{link_root_name}/lines-and-columns@1.2.4/ref": "lines-and-columns",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@babel+code-frame@7.27.1/pkg": "@babel/code-frame",
            ":.aspect_rules_js/{link_root_name}/@babel+helper-validator-identifier@7.27.1/pkg": "@babel/helper-validator-identifier",
            ...
            ":.aspect_rules_js/{link_root_name}/json-parse-even-better-errors@2.3.1/pkg": "json-parse-even-better-errors",
            ":.aspect_rules_js/{link_root_name}/lines-and-columns@1.2.4/pkg": "lines-and-columns",
            ":.aspect_rules_js/{link_root_name}/parse-json@5.2.0/pkg_pre_lc_lite": "parse-json",
            ":.aspect_rules_js/{link_root_name}/picocolors@1.1.1/pkg": "picocolors",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__parse-json__5.2.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package parse-json@5.2.0
# buildifier: disable=function-docstring
