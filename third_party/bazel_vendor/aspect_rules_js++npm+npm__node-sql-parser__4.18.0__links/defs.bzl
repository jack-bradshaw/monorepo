"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package node-sql-parser@4.18.0"
...
VERSION = "4.18.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "node-sql-parser@4.18.0"

# Generated npm_package_store targets for npm package node-sql-parser@4.18.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/big-integer@1.6.52/ref": "big-integer",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/big-integer@1.6.52/pkg": "big-integer",
            ":.aspect_rules_js/{link_root_name}/node-sql-parser@4.18.0/pkg_pre_lc_lite": "node-sql-parser",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__node-sql-parser__4.18.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package node-sql-parser@4.18.0
# buildifier: disable=function-docstring
