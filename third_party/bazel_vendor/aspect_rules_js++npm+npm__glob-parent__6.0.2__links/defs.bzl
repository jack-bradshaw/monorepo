"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package glob-parent@6.0.2"
...
VERSION = "6.0.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "glob-parent@6.0.2"

# Generated npm_package_store targets for npm package glob-parent@6.0.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/glob-parent@6.0.2/pkg_pre_lc_lite": "glob-parent",
            ":.aspect_rules_js/{link_root_name}/is-extglob@2.1.1/pkg": "is-extglob",
            ":.aspect_rules_js/{link_root_name}/is-glob@4.0.3/pkg": "is-glob",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__glob-parent__6.0.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package glob-parent@6.0.2
# buildifier: disable=function-docstring
