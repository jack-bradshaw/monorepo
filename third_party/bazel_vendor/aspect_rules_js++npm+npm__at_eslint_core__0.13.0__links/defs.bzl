"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @eslint/core@0.13.0"
...
VERSION = "0.13.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@eslint+core@0.13.0"

# Generated npm_package_store targets for npm package @eslint/core@0.13.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+core@0.13.0/pkg_pre_lc_lite": "@eslint/core",
            ":.aspect_rules_js/{link_root_name}/@types+json-schema@7.0.15/pkg": "@types/json-schema",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_eslint_core__0.13.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @eslint/core@0.13.0
# buildifier: disable=function-docstring
