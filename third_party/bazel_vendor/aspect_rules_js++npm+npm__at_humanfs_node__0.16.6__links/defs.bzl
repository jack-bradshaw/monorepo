"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @humanfs/node@0.16.6"
...
VERSION = "0.16.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@humanfs+node@0.16.6"

# Generated npm_package_store targets for npm package @humanfs/node@0.16.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/@humanfs+core@0.19.1/ref": "@humanfs/core",
            ":.aspect_rules_js/{link_root_name}/@humanwhocodes+retry@0.3.1/ref": "@humanwhocodes/retry",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@humanfs+core@0.19.1/pkg": "@humanfs/core",
            ":.aspect_rules_js/{link_root_name}/@humanfs+node@0.16.6/pkg_pre_lc_lite": "@humanfs/node",
            ":.aspect_rules_js/{link_root_name}/@humanwhocodes+retry@0.3.1/pkg": "@humanwhocodes/retry",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_humanfs_node__0.16.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @humanfs/node@0.16.6
# buildifier: disable=function-docstring
