"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package cross-spawn@7.0.6"
...
VERSION = "7.0.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "cross-spawn@7.0.6"

# Generated npm_package_store targets for npm package cross-spawn@7.0.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/path-key@3.1.1/ref": "path-key",
            ":.aspect_rules_js/{link_root_name}/shebang-command@2.0.0/ref": "shebang-command",
            ":.aspect_rules_js/{link_root_name}/which@2.0.2/ref": "which",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/cross-spawn@7.0.6/pkg_pre_lc_lite": "cross-spawn",
            ":.aspect_rules_js/{link_root_name}/isexe@2.0.0/pkg": "isexe",
            ":.aspect_rules_js/{link_root_name}/path-key@3.1.1/pkg": "path-key",
            ":.aspect_rules_js/{link_root_name}/shebang-command@2.0.0/pkg": "shebang-command",
            ":.aspect_rules_js/{link_root_name}/shebang-regex@3.0.0/pkg": "shebang-regex",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__cross-spawn__7.0.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package cross-spawn@7.0.6
# buildifier: disable=function-docstring
