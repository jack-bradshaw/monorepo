"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package chevrotain@7.1.1"
...
VERSION = "7.1.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "chevrotain@7.1.1"

# Generated npm_package_store targets for npm package chevrotain@7.1.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/regexp-to-ast@0.5.0/ref": "regexp-to-ast",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/chevrotain@7.1.1/pkg_pre_lc_lite": "chevrotain",
            ":.aspect_rules_js/{link_root_name}/regexp-to-ast@0.5.0/pkg": "regexp-to-ast",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__chevrotain__7.1.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package chevrotain@7.1.1
# buildifier: disable=function-docstring
