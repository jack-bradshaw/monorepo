"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package ini@1.3.8"
...
VERSION = "1.3.8"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "ini@1.3.8"

# Generated npm_package_store targets for npm package ini@1.3.8
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ini@1.3.8/pkg_pre_lc_lite": "ini",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__ini__1.3.8//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package ini@1.3.8
# buildifier: disable=function-docstring
