"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package file-entry-cache@7.0.2"
...
VERSION = "7.0.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "file-entry-cache@7.0.2"

# Generated npm_package_store targets for npm package file-entry-cache@7.0.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/flat-cache@3.2.0/ref": "flat-cache",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/pkg": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/pkg": "concat-map",
            ":.aspect_rules_js/{link_root_name}/file-entry-cache@7.0.2/pkg_pre_lc_lite": "file-entry-cache",
            ":.aspect_rules_js/{link_root_name}/flat-cache@3.2.0/pkg": "flat-cache",
            ":.aspect_rules_js/{link_root_name}/flatted@3.3.3/pkg": "flatted",
            ":.aspect_rules_js/{link_root_name}/fs.realpath@1.0.0/pkg": "fs.realpath",
            ":.aspect_rules_js/{link_root_name}/glob@7.2.3/pkg": "glob",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__file-entry-cache__7.0.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package file-entry-cache@7.0.2
# buildifier: disable=function-docstring
