"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package randexp@0.4.6"
...
VERSION = "0.4.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "randexp@0.4.6"

# Generated npm_package_store targets for npm package randexp@0.4.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/discontinuous-range@1.0.0/ref": "discontinuous-range",
            ":.aspect_rules_js/{link_root_name}/ret@0.1.15/ref": "ret",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/discontinuous-range@1.0.0/pkg": "discontinuous-range",
            ":.aspect_rules_js/{link_root_name}/randexp@0.4.6/pkg_pre_lc_lite": "randexp",
            ":.aspect_rules_js/{link_root_name}/ret@0.1.15/pkg": "ret",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__randexp__0.4.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package randexp@0.4.6
# buildifier: disable=function-docstring
