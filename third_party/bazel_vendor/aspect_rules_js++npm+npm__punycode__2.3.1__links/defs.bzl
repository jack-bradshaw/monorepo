"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package punycode@2.3.1"
...
VERSION = "2.3.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "punycode@2.3.1"

# Generated npm_package_store targets for npm package punycode@2.3.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/punycode@2.3.1/pkg_pre_lc_lite": "punycode",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__punycode__2.3.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package punycode@2.3.1
# buildifier: disable=function-docstring
