"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package braces@3.0.3"
...
VERSION = "3.0.3"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "braces@3.0.3"

# Generated npm_package_store targets for npm package braces@3.0.3
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/fill-range@7.1.1/ref": "fill-range",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/braces@3.0.3/pkg_pre_lc_lite": "braces",
            ":.aspect_rules_js/{link_root_name}/fill-range@7.1.1/pkg": "fill-range",
            ":.aspect_rules_js/{link_root_name}/is-number@7.0.0/pkg": "is-number",
            ":.aspect_rules_js/{link_root_name}/to-regex-range@5.0.1/pkg": "to-regex-range",
        },
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__braces__3.0.3//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package braces@3.0.3
# buildifier: disable=function-docstring
