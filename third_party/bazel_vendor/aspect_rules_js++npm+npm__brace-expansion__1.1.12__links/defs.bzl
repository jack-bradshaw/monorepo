"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package brace-expansion@1.1.12"
...
VERSION = "1.1.12"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "brace-expansion@1.1.12"

# Generated npm_package_store targets for npm package brace-expansion@1.1.12
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/ref": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/ref": "concat-map",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/pkg_pre_lc_lite": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/pkg": "concat-map",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__brace-expansion__1.1.12//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package brace-expansion@1.1.12
# buildifier: disable=function-docstring
