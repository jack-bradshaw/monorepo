"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package is-glob@4.0.3"
...
VERSION = "4.0.3"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "is-glob@4.0.3"

# Generated npm_package_store targets for npm package is-glob@4.0.3
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/is-extglob@2.1.1/ref": "is-extglob",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/is-extglob@2.1.1/pkg": "is-extglob",
            ":.aspect_rules_js/{link_root_name}/is-glob@4.0.3/pkg_pre_lc_lite": "is-glob",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__is-glob__4.0.3//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package is-glob@4.0.3
# buildifier: disable=function-docstring
