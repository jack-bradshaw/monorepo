"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package dir-glob@3.0.1"
...
VERSION = "3.0.1"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "dir-glob@3.0.1"

# Generated npm_package_store targets for npm package dir-glob@3.0.1
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/path-type@4.0.0/ref": "path-type",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/dir-glob@3.0.1/pkg_pre_lc_lite": "dir-glob",
            ":.aspect_rules_js/{link_root_name}/path-type@4.0.0/pkg": "path-type",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__dir-glob__3.0.1//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package dir-glob@3.0.1
# buildifier: disable=function-docstring
