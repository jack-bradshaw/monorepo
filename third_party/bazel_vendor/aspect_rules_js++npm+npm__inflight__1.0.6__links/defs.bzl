"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package inflight@1.0.6"
...
VERSION = "1.0.6"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "inflight@1.0.6"

# Generated npm_package_store targets for npm package inflight@1.0.6
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/wrappy@1.0.2/ref": "wrappy",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/inflight@1.0.6/pkg_pre_lc_lite": "inflight",
            ":.aspect_rules_js/{link_root_name}/once@1.4.0/pkg": "once",
            ":.aspect_rules_js/{link_root_name}/wrappy@1.0.2/pkg": "wrappy",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__inflight__1.0.6//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package inflight@1.0.6
# buildifier: disable=function-docstring
