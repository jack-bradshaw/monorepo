"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package type-check@0.4.0"
...
VERSION = "0.4.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "type-check@0.4.0"

# Generated npm_package_store targets for npm package type-check@0.4.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/prelude-ls@1.2.1/pkg": "prelude-ls",
            ":.aspect_rules_js/{link_root_name}/type-check@0.4.0/pkg_pre_lc_lite": "type-check",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__type-check__0.4.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package type-check@0.4.0
# buildifier: disable=function-docstring
