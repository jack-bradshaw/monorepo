"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package eslint-scope@8.4.0"
...
VERSION = "8.4.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "eslint-scope@8.4.0"

# Generated npm_package_store targets for npm package eslint-scope@8.4.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/esrecurse@4.3.0/ref": "esrecurse",
            ":.aspect_rules_js/{link_root_name}/estraverse@5.3.0/ref": "estraverse",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/eslint-scope@8.4.0/pkg_pre_lc_lite": "eslint-scope",
            ":.aspect_rules_js/{link_root_name}/esrecurse@4.3.0/pkg": "esrecurse",
            ":.aspect_rules_js/{link_root_name}/estraverse@5.3.0/pkg": "estraverse",
        },
        dev = False,
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__eslint-scope__8.4.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package eslint-scope@8.4.0
# buildifier: disable=function-docstring
