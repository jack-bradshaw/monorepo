"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package flat-cache@3.2.0"
...
VERSION = "3.2.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "flat-cache@3.2.0"

# Generated npm_package_store targets for npm package flat-cache@3.2.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/flatted@3.3.3/ref": "flatted",
            ":.aspect_rules_js/{link_root_name}/keyv@4.5.4/ref": "keyv",
            ":.aspect_rules_js/{link_root_name}/rimraf@3.0.2/ref": "rimraf",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/pkg": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/pkg": "concat-map",
            ":.aspect_rules_js/{link_root_name}/flat-cache@3.2.0/pkg_pre_lc_lite": "flat-cache",
            ":.aspect_rules_js/{link_root_name}/flatted@3.3.3/pkg": "flatted",
            ":.aspect_rules_js/{link_root_name}/fs.realpath@1.0.0/pkg": "fs.realpath",
            ":.aspect_rules_js/{link_root_name}/glob@7.2.3/pkg": "glob",
            ":.aspect_rules_js/{link_root_name}/inflight@1.0.6/pkg": "inflight",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__flat-cache__3.2.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package flat-cache@3.2.0
# buildifier: disable=function-docstring
