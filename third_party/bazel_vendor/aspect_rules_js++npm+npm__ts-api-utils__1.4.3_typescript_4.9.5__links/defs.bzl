"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package ts-api-utils@1.4.3_typescript_4.9.5"
...
VERSION = "1.4.3_typescript_4.9.5"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "ts-api-utils@1.4.3_typescript_4.9.5"

# Generated npm_package_store targets for npm package ts-api-utils@1.4.3_typescript_4.9.5
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ts-api-utils@1.4.3_typescript_4.9.5/pkg_pre_lc_lite": "ts-api-utils",
            ":.aspect_rules_js/{link_root_name}/typescript@4.9.5/pkg": "typescript",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__ts-api-utils__1.4.3_typescript_4.9.5//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package ts-api-utils@1.4.3_typescript_4.9.5
# buildifier: disable=function-docstring
