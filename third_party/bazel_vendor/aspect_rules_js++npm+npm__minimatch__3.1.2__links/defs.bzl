"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package minimatch@3.1.2"
...
VERSION = "3.1.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "minimatch@3.1.2"

# Generated npm_package_store targets for npm package minimatch@3.1.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/ref": "brace-expansion",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/balanced-match@1.0.2/pkg": "balanced-match",
            ":.aspect_rules_js/{link_root_name}/brace-expansion@1.1.12/pkg": "brace-expansion",
            ":.aspect_rules_js/{link_root_name}/concat-map@0.0.1/pkg": "concat-map",
            ":.aspect_rules_js/{link_root_name}/minimatch@3.1.2/pkg_pre_lc_lite": "minimatch",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__minimatch__3.1.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package minimatch@3.1.2
# buildifier: disable=function-docstring
