"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package ret@0.1.15"
...
VERSION = "0.1.15"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "ret@0.1.15"

# Generated npm_package_store targets for npm package ret@0.1.15
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ret@0.1.15/pkg_pre_lc_lite": "ret",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__ret__0.1.15//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package ret@0.1.15
# buildifier: disable=function-docstring
