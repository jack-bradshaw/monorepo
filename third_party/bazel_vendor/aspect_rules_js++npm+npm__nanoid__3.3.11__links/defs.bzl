"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package nanoid@3.3.11"
...
VERSION = "3.3.11"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "nanoid@3.3.11"

# Generated npm_package_store targets for npm package nanoid@3.3.11
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/nanoid@3.3.11/pkg_pre_lc_lite": "nanoid",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__nanoid__3.3.11//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package nanoid@3.3.11
# buildifier: disable=function-docstring
