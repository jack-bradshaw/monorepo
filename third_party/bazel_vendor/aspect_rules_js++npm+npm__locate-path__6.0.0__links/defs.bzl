"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package locate-path@6.0.0"
...
VERSION = "6.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "locate-path@6.0.0"

# Generated npm_package_store targets for npm package locate-path@6.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/p-locate@5.0.0/ref": "p-locate",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/locate-path@6.0.0/pkg_pre_lc_lite": "locate-path",
            ":.aspect_rules_js/{link_root_name}/p-limit@3.1.0/pkg": "p-limit",
            ":.aspect_rules_js/{link_root_name}/p-locate@5.0.0/pkg": "p-locate",
            ":.aspect_rules_js/{link_root_name}/yocto-queue@0.1.0/pkg": "yocto-queue",
        },
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__locate-path__6.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package locate-path@6.0.0
# buildifier: disable=function-docstring
