"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package slice-ansi@4.0.0"
...
VERSION = "4.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "slice-ansi@4.0.0"

# Generated npm_package_store targets for npm package slice-ansi@4.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ...
            ":.aspect_rules_js/{link_root_name}/astral-regex@2.0.0/ref": "astral-regex",
            ":.aspect_rules_js/{link_root_name}/is-fullwidth-code-point@3.0.0/ref": "is-fullwidth-code-point",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/ansi-styles@4.3.0/pkg": "ansi-styles",
            ":.aspect_rules_js/{link_root_name}/astral-regex@2.0.0/pkg": "astral-regex",
            ...
            ":.aspect_rules_js/{link_root_name}/color-name@1.1.4/pkg": "color-name",
            ":.aspect_rules_js/{link_root_name}/is-fullwidth-code-point@3.0.0/pkg": "is-fullwidth-code-point",
            ":.aspect_rules_js/{link_root_name}/slice-ansi@4.0.0/pkg_pre_lc_lite": "slice-ansi",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__slice-ansi__4.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package slice-ansi@4.0.0
# buildifier: disable=function-docstring
