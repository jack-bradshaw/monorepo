"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package find-up@5.0.0"
...
VERSION = "5.0.0"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "find-up@5.0.0"

# Generated npm_package_store targets for npm package find-up@5.0.0
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/locate-path@6.0.0/ref": "locate-path",
            ":.aspect_rules_js/{link_root_name}/path-exists@4.0.0/ref": "path-exists",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/find-up@5.0.0/pkg_pre_lc_lite": "find-up",
            ":.aspect_rules_js/{link_root_name}/locate-path@6.0.0/pkg": "locate-path",
            ":.aspect_rules_js/{link_root_name}/p-limit@3.1.0/pkg": "p-limit",
            ":.aspect_rules_js/{link_root_name}/p-locate@5.0.0/pkg": "p-locate",
            ":.aspect_rules_js/{link_root_name}/path-exists@4.0.0/pkg": "path-exists",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__find-up__5.0.0//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package find-up@5.0.0
# buildifier: disable=function-docstring
