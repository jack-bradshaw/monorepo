"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package lodash.truncate@4.4.2"
...
PACKAGE = "lodash.truncate"
VERSION = "4.4.2"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "lodash.truncate@4.4.2"

# Generated npm_package_store targets for npm package lodash.truncate@4.4.2
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/lodash.truncate@4.4.2/pkg_pre_lc_lite": "lodash.truncate",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__lodash.truncate__4.4.2//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package lodash.truncate@4.4.2
# buildifier: disable=function-docstring
