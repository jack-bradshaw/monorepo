"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @eslint/plugin-kit@0.2.8"
...
VERSION = "0.2.8"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@eslint+plugin-kit@0.2.8"

# Generated npm_package_store targets for npm package @eslint/plugin-kit@0.2.8
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+core@0.13.0/ref": "@eslint/core",
            ":.aspect_rules_js/{link_root_name}/levn@0.4.1/ref": "levn",
        },
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@eslint+core@0.13.0/pkg": "@eslint/core",
            ":.aspect_rules_js/{link_root_name}/@eslint+plugin-kit@0.2.8/pkg_pre_lc_lite": "@eslint/plugin-kit",
            ":.aspect_rules_js/{link_root_name}/@types+json-schema@7.0.15/pkg": "@types/json-schema",
            ":.aspect_rules_js/{link_root_name}/levn@0.4.1/pkg": "levn",
            ":.aspect_rules_js/{link_root_name}/prelude-ls@1.2.1/pkg": "prelude-ls",
            ":.aspect_rules_js/{link_root_name}/type-check@0.4.0/pkg": "type-check",
        ...
        npm_package_target = "@@aspect_rules_js++npm+npm__at_eslint_plugin-kit__0.2.8//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @eslint/plugin-kit@0.2.8
# buildifier: disable=function-docstring
