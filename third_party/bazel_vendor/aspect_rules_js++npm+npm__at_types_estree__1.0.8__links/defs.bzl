"@generated by @aspect_rules_js//npm/private:npm_import.bzl for npm package @types/estree@1.0.8"
...
VERSION = "1.0.8"
_ROOT_PACKAGE = ""
_PACKAGE_STORE_NAME = "@types+estree@1.0.8"

# Generated npm_package_store targets for npm package @types/estree@1.0.8
...
def npm_imported_package_store(link_root_name):
    _npm_imported_package_store(
        ...
        ref_deps = {},
        lc_deps = {
            ":.aspect_rules_js/{link_root_name}/@types+estree@1.0.8/pkg_pre_lc_lite": "@types/estree",
        },
        dev = False,
        has_lifecycle_build_target = False,
        transitive_closure_pattern = True,
        npm_package_target = "@@aspect_rules_js++npm+npm__at_types_estree__1.0.8//:pkg",
...
# Generated npm_package_store and npm_link_package_store targets for npm package @types/estree@1.0.8
# buildifier: disable=function-docstring
