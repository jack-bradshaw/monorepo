...
# Rename files
os.rename(
    "first_party/concurrency/quinn/testing/factory/IdleableQuinnHubImpl.kt",
    "first_party/concurrency/quinn/testing/factory/IdleableQuinnFactoryImpl.kt",
)
os.rename(
    "first_party/concurrency/quinn/testing/factory/IdleableQuinnHubModule.kt",
...
for f in files:
    ...
    replace_in_file(
        f, "factory/IdleableQuinnHubImpl.kt", "factory/IdleableQuinnFactoryImpl.kt"
    )
    replace_in_file(
        f, "factory/IdleableQuinnHubModule.kt", "factory/IdleableQuinnFactoryModule.kt"
    )
