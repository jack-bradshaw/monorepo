...
# Artifacts used directly in targets.
PRIMARY_ARTIFACTS = [
    "androidx.activity:activity-compose:1.9.0",
    "androidx.core:core:1.13.1",
    "androidx.appcompat:appcompat:1.7.0",
    "androidx.compose.foundation:foundation:%s" % ANDROIDX_COMPOSE_VERSION,
...
# Artifacts needed to resolve version conflicts but not used directly in targets.
CONFLICT_RESOLUTION_ARTIFACTS = [
...
def io_jackbradshaw_maven_repositories():
    maybe(
        ...
        artifacts = PRIMARY_ARTIFACTS + CONFLICT_RESOLUTION_ARTIFACTS,
        repositories = [
