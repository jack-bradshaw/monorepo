package com.jackbradshaw.kmonkey.coroutines
...
/**
 * A cache of rendering dispatchers, keyed by [Application]. To ensure the next call to
 * [renderingDispatcher] returns a new dispatcher, remove the map entry for the application from
 * here.
 */
val RENDERING_DISPATCHERS = ConcurrentHashMap<Application, JMonkeyRenderingDispatcher>()

/**
 * A cache of physics dispatchers, keyed by [PhysicsSpace]. To ensure the next call to
 * [physicsDispatcher] returns a new dispatcher, remove the map entry for the physics space from
 * here.
 */
private val PHYSICS_DISPATCHERS = ConcurrentHashMap<PhysicsSpace, JMonkeyPhysicsDispatcher>()

/**
 * Gets a [CoroutineDispatcher] that executes coroutines on the rendering thread of this
 * [Application].
 *
...
/**
 * Gets a [CoroutineDispatcher] that executes coroutines on the physics thread of this
 * [PhysicsSpace].
 *
