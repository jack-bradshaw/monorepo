...
/**
 * Creates a new vector that is the normalized form of this vector
 * (https://en.wikipedia.org/wiki/Unit_vector).
 */
fun Vector.normalize(): Vector = this / length()

/**
 * Calculates the projection (https://en.wikipedia.org/wiki/Vector_projection) of this vector onto
 * [other]
 */
