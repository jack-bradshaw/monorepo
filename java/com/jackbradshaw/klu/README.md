...
3. Start the build: `bazel build //java/com/jackbradshaw/klu:binary.deploy`

This will produce a jar in the `monorepo/bazel-out/java/com/jackbradshaw/klu` directory. Copy this Jar into your
project as needed.
...
kt_jvm_library(
    ...
    srcs = "HelloWorld.kt",
    deps = [
        "@com_jackbradshaw//:java/com/jackbradshaw/klu",
    ]
)
```
...
- [Concurrency](https://github.com/jack-bradshaw/monorepo/blob/main/java/com/jackbradshaw/klu/concurrency)
- [Flows](https://github.com/jack-bradshaw/monorepo/blob/main/java/com/jackbradshaw/klu/flow)
