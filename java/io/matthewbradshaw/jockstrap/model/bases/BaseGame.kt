package java.io.matthewbradshaw.jockstrap.model.bases
...
import io.matthewbradshaw.jockstrap.snapshot.SnapshotStore
import io.matthewbradshaw.jockstrap.structure.level.LevelId
import io.matthewbradshaw.jockstrap.structure.level.LevelSnapshot
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.sync.Mutex
import kotlinx.coroutines.sync.withLock
import java.io.matthewbradshaw.jockstrap.model.elements.*

// this class still needs some logic to attach the level to the engine
  ...
  private suspend fun Level.save(): SaveResult {
    return try {
      ...
      if (canSnapshot) {
        ...
        java.io.matthewbradshaw.jockstrap.model.elements.SaveResult.Done
      } else {
        java.io.matthewbradshaw.jockstrap.model.elements.SaveResult.SnapshotUnavailable
      }
    } catch (e: Exception) {
      java.io.matthewbradshaw.jockstrap.model.elements.SaveResult.GenericFailure(e)
    }
  }
