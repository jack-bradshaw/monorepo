package java.io.matthewbradshaw.jockstrap.bases
...
import java.io.matthewbradshaw.jockstrap.elements.*
  ...
  private suspend fun Level.save(): SaveResult {
    return try {
      ...
      if (canSnapshot) {
        ...
        java.io.matthewbradshaw.jockstrap.elements.SaveResult.Done
      } else {
        java.io.matthewbradshaw.jockstrap.elements.SaveResult.SnapshotUnavailable
      }
    } catch (e: Exception) {
      java.io.matthewbradshaw.jockstrap.elements.SaveResult.GenericFailure(e)
    }
  }
